...
export default function Home() {
  ...
  return (
    <main className="min-h-screen bg-white text-[#262626] font-sans antialiased overflow-x-hidden selection:bg-[#1c69d4] selection:text-white">
      <Navbar />
        ...
        <div className="relative z-10 w-full max-w-7xl mx-auto px-6 lg:px-12 pt-24 pb-12">
          <div className="max-w-3xl space-y-8">
            <div className="space-y-4">
              <span className="text-[#1c69d4] uppercase tracking-[0.2em] text-xs font-bold font-sans block">
              ...
              <h1 className="text-5xl sm:text-6xl md:text-7xl lg:text-[5rem] text-white font-light uppercase leading-[1.1] tracking-tight">
                ...
                KENDARAAN
                <br />
                <span className="text-white font-bold">ANDA.</span>
              </h1>
              <p className="text-[#bbbbbb] text-lg font-sans leading-relaxed max-w-xl">
                Rasakan sensasi berkendara dengan unit terbaik dari SRB Motor.
                Performa maksimal untuk perjalanan tak terbatas.
              </p>
            </div>

            <div className="flex flex-col sm:flex-row gap-4 pt-8">
              <Link href="/gallery">
                <button className="w-full sm:w-auto relative px-10 py-4 bg-[#ffffff] text-[#262626] font-bold uppercase text-xs tracking-widest transition-colors hover:bg-[#1c69d4] hover:text-white rounded-none border border-transparent shadow-none flex items-center justify-center gap-3 cursor-pointer">
                  Lihat Koleksi
      ...
      <section className="bg-white border-b border-gray-200">
        <div className="max-w-7xl mx-auto px-6 lg:px-12 py-12 flex flex-col lg:flex-row gap-12 items-center">
          <div className="lg:w-1/3 space-y-2">
            ...
            <p className="text-[#757575] text-sm">Temukan unit spesifik</p>
          </div>
            ...
            <div className="flex flex-col sm:flex-row shadow-sm border border-gray-300 rounded-none bg-white">
              <div className="flex-1 flex items-center px-4 py-2">
                ...
                <input
                  ...
                  className="w-full border-none focus:ring-0 text-base text-[#262626] bg-transparent py-3 placeholder:text-[#bbbbbb] font-sans outline-none"
                />
              </div>
              <button
                onClick={handleSearchSubmit}
                className="px-8 py-4 bg-[#1c69d4] hover:bg-[#0653b6] text-white font-bold uppercase text-xs tracking-widest transition-colors rounded-none cursor-pointer"
              >
                Cari Unit
              </button>
            </div>
            ...
            {[
              {
                label: "Unit Terjual",
                value: "10.000+",
                icon: <Bike className="w-5 h-5 text-[#1c69d4]" />,
              },
              {
                label: "Teknisi Ahli",
                value: "25+",
                icon: <Award className="w-5 h-5 text-[#1c69d4]" />,
              },
              {
                label: "Pelanggan Puas",
                value: "8.500+",
                icon: <Users className="w-5 h-5 text-[#1c69d4]" />,
              },
              {
                label: "Tahun Pengalaman",
                value: "12 Tahun",
                icon: <Clock className="w-5 h-5 text-[#1c69d4]" />,
              },
            ].map((stat, i) => (
              <div
                key={i}
          ...
          <div className="flex flex-col md:flex-row justify-between items-end mb-16 gap-6">
            <div>
              <h2 className="text-4xl font-light text-[#262626] uppercase tracking-tight">
                Merek <span className="font-bold">Unggulan</span>
              </h2>
            </div>
            <Link
              href="/gallery"
            ...
            >
              Eksplorasi Katalog <ChevronRight className="w-4 h-4" />
            </Link>
          </div>
            ...
            {brands.map((brand, index) => (
              <Link
                ...
                className={`relative group p-12 bg-white border border-gray-200 transition-colors duration-300 flex flex-col items-center justify-center min-h-[300px] overflow-hidden rounded-none ${
                  !brand.available ? "opacity-50" : "hover:border-[#262626]"
                }`}
              >
      ...
      <section className="py-24 bg-[#f9f9f9]">
        <div className="max-w-7xl mx-auto px-6 lg:px-12 text-center lg:text-left">
          <div className="mb-16 space-y-4">
            <span className="text-[#1c69d4] font-black text-[10px] tracking-[0.4em] uppercase block">
              PROSES PEMESANAN
            </span>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
            {[
              ...
              >
                <div className="absolute top-10 right-10 text-4xl font-black text-gray-100 opacity-0 group-hover:opacity-100 transition-opacity duration-500">
                  {item.step}
                </div>
                <div className="w-12 h-12 bg-[#1c69d4] flex items-center justify-center text-white mb-8 group-hover:scale-110 transition-transform duration-300">
                  {item.icon}
                </div>
          ...
          <div className="flex flex-col lg:flex-row justify-between items-center lg:items-end gap-12 mb-20 border-b border-white/10 pb-16">
            <div className="max-w-4xl space-y-4 md:space-y-6 w-full">
              <div className="flex items-center gap-4 justify-center lg:justify-start">
                ...
                <span className="text-[#1c69d4] font-black text-[9px] md:text-[10px] tracking-[0.4em] uppercase block">
              ...
              <p className="text-gray-400 font-medium text-[10px] md:text-xs lg:text-base max-w-xl lg:max-w-none mx-auto lg:mx-0 uppercase tracking-widest leading-relaxed opacity-70 mt-4 lg:mt-0">
                Melalui Sinar Surya Matahari (SRB MOTOR - SSM), nikmati performa
                terbaik bagi kendaraan Yamaha & Honda Anda dengan suku cadang
                asli dan teknisi bersertifikasi.
              </p>
            </div>
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[
              ...
              >
                <div className="flex text-[#1c69d4] mb-8 group-hover:scale-110 transition-transform duration-300">
                  {[...Array(5)].map((_, idx) => (
          ...
          <div className="flex flex-col items-center text-center space-y-12">
            ...
            >
              ...
              <p className="text-gray-400 font-medium text-sm md:text-lg max-w-2xl mx-auto uppercase tracking-widest leading-relaxed opacity-80">
                Temukan unit impian Anda dari katalog lengkap Yamaha & Honda.{" "}
                <br className="hidden md:block" />
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-12 py-24">
          <div className="flex flex-col md:flex-row justify-between items-center gap-12 bg-[#262626] p-12 lg:p-20 relative overflow-hidden rounded-none">
            <div className="absolute right-0 top-0 w-1/2 h-full opacity-10 pointer-events-none">
              <span className="text-[200px] leading-none absolute -right-10 -top-10 font-bold text-white">
                SRB
              </span>
            </div>
            <div className="relative z-10 max-w-xl text-center md:text-left">
              <h2 className="text-3xl md:text-4xl text-white font-light uppercase tracking-wide leading-tight mb-6">
                Hubungi <span className="font-bold">Konsultan Kami</span>
              </h2>
              <p className="text-[#bbbbbb] font-sans">
                Hubungi SRB Motors untuk konsultasi pemesanan, simulasi kredit,
